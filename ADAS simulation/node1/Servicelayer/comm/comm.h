...
#define Diagnostic1_sw_ID 1U
#define Diagnostic2_sw_ID 2U

#define num_of_tx_message 3U

#define pass_token_data_length 3U
#define Diagnostic1_data_length    3U
#define Diagnostic2_data_length    3U


#define TX_PDUs_len       {pass_token_data_length,Diagnostic1_data_length ,Diagnostic2_data_length}
