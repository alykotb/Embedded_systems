...
void CAN_Init(void)
{
    SysCtlPeripheralEnable(SYSCTL_PERIPH_GPIOE);/*enabling clock for GPIO port used BY can controller*/
     ...
     g_sCANMsgObject1.ui32MsgID =ecu2_address  ;/*initialisation of the id sent by message object 1*/
     ...
     g_sCANMsgObject2.ui32MsgID =ecu1_address; /*initia_lization of the id received by message object 1*/
